                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card__body">
                                        <Formik initialValues={product} validationSchema={validationSchema}
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-6">
                                                            <div className="form-group">
                                                                ...
                                                                />
                                                                <ErrorMessage name="category_id" className="error"
                                                                              component="div"/>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-6">
                                                            <div className="form-group">
                                                                ...
                                                                <FastField name="sale_off" component={InputField}
                                                                           type="number"
                                                        ...
                                                        <div className="col-6">
                                                            <div className="form-group">
                                                                ...
                                                                <FastField name="cotton" component={InputField}
                                                                           type="number"
                                                                           value={values.cotton}
                                                    ...
                                                    <div className="row">
                                                        <div className="col-6">
                                                            <div className="form-group">
                                                                ...
                                                                <FastField name="form" component={InputField}
                                                                           type="text"
                                                                           value={values.form}
                                                        ...
                                                        <div className="col-6">
                                                            <div className="form-group">
                                                                ...
                                                                <FastField name="type" component={InputField}
                                                                           type="text"
                                                                            value={values.type}
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-6">
                                                            <div className="form-group">
                                                                ...
                                                                <FastField name="made_in" component={InputField}
                                                                           type="text"
                                                        ...
                                                        <div className="col-6">
                                                            <div className="form-group">
                                                                ...
                                                                <Select
                                                                    ...
                                                                    getOptionLabel={(option) => option.label}
                                                                    getOptionValue={(option) => option.value}
                                                                    value={brands.filter((option) => values.brand_id.includes(option.value))}
                                                                    onChange={(e) => {
                                                                        // Lấy label và value của các lựa chọn được chọn
                                                                ...
                                                                />
                                                                <ErrorMessage name="brand_id" className="error"
                                                                              component="div"/>
                                                            </div>
                                                        </div>
